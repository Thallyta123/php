...
<body>
  ...
  <p>
    ...
    em todo o mundo. Fundada há <?php print date("Y") - 1932; ?>, possui filiais em 124 países, sendo
  ...
  <p>
    ...
    entre em contato se tiver dúvidas. Conheça também nossa história e <a href="#diferenciais">nossos
      diferenciais.</a>
  </p>
  ...
  <p>
    ...
    <em>Eduardo Simões Pelho</em>, dotado de particular visão administrativa, guiou os
    negócios da empresa durante mais de 50 anos, muitos deles ao lado de seu
    filho <em>E. S. Pelho Filho, atual CEO</em>. O nome da empresa é inspirado no nome
    da família.
  </p>
  ...
  <h1>Mais de um milhão de funcionários em todo o mundo</h1>

  <p>
    visite o site da <a href="index.html">Visite nossa loja</a>
  </p>
